...
export default function TipoProducto({title,src}) {
  return (
    <div className="relative group bg-gray-200  hover:text-blue-700 transition-colors duration-200 ease-in-out p-4 rounded-md max-w-[300px]">
