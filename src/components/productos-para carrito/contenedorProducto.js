...
export default function ContenedorProductos({ idioma, productos }) {
  ...
  return (
    <div className="flex flex-col my-10">
      <div className="flex text-2xl text-orange-500 bold justify-center mb-4">
      ...
      <div className="flex flex-wrap justify-around gap-10 p-4">
        {datosProductos.productos.map((producto, index) => (
          <TipoProducto key={index} title={producto.title} src={producto.src.src} link={producto.url} alt={producto.alt} />
        ))}
      </div>
    </div>
